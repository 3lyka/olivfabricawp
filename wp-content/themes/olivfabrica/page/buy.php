...
<img src="<?php bloginfo('template_url'); ?>/assets/img/bank-icon/EuropBank.png" alt="">
</div>
<div class="col-sm col-md-2 mb-1">
<img src="<?php bloginfo('template_url'); ?>/assets/img/bank-icon/MTSbank.png" alt="">
</div>
<div class="col-sm col-md-2 mb-1">
<img src="<?php bloginfo('template_url'); ?>/assets/img/bank-icon/RenesansBank.png" alt="">
</div>
<div class="col-sm col-md-2 mb-1">
<img src="<?php bloginfo('template_url'); ?>/assets/img/bank-icon/SberBank.png" alt="">
</div>
<div class="col-sm col-md-2 mb-1">
<img src="<?php bloginfo('template_url'); ?>/assets/img/bank-icon/TinkoffBank.png" alt="">
</div>
<div class="col-sm col-md-2 mb-1">
<img src="<?php bloginfo('template_url'); ?>/assets/img/bank-icon/VostochBank.png" alt="">
</div>
</div>
</div>
